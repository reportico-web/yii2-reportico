...
$g_translations = array (
        "en_gb" => array ( 
            ...
            "HELP_PROJECT_NAME" => "The name of the project. A folder with this name will be created under the 'projects' folder under the yii runtime/reportico folder",
            ...
            "HELP_DATABASE_TYPE" => "The type of database you wish to report against. To report against the tables within your 
